...
--	DBM_NEFARIAN_BLOCK_HEALS		= "Heilung w\195\164hrend Priester Calls blockieren";
	...
	DBM_NEFARIAN_DRAKONID_DOWN[1] = "Schwarzer Drakonid";
	DBM_NEFARIAN_DRAKONID_DOWN[2] = "Blauer Drakonid";
	DBM_NEFARIAN_DRAKONID_DOWN[3] = "Grüner Drakonid";
	DBM_NEFARIAN_DRAKONID_DOWN[4] = "Bronzener Drakonid";
	DBM_NEFARIAN_DRAKONID_DOWN[5] = "Roter Drakonid";
	DBM_NEFARIAN_DRAKONID_DOWN[6] = "Prismatischer Drakonid";

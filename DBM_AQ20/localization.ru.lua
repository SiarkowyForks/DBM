...
-- 1. Kurinaxx
DBM_KURINAXX_NAME			= "Куриннакс";

-- 2. General Rajaxx
DBM_RAJAXX_NAME				= "Генерал Раджакс";
...
DBM_MOAM_SPELLID_STONE		= 25685

-- 4. Buru the Gorger
DBM_BURU_NAME			= "Буру Ненасытный";
...
DBM_AYAMISS_NAME		= "Аймисса Охотница";
...
DBM_AYAMISS_SPELLID_SACRIFICE	= 25725

-- 6. Ossirian the Unscarred
DBM_OSSIRIAN_NAME		= "Оссириан Неуязвимый";
...
DBM_OSSIRIAN_CURSE_EXPR 	= "Curse of Tongues";
...
DBM_OSSIRIAN_WEAK_EXPR		= "(.+) Weakness";
DBM_OSSIRIAN_WEAK_RUNOUT	= "*** Supreme Mode in %d seconds ***";
DBM_OSSIRIAN_SUPREME_EXPR	= "Оссириан Неуязвимый gains Strength of Ossirian.";
DBM_OSSIRIAN_SUPREME_ANNOUNCE	= "*** Supreme Mode ***";
DBM_OSSIRIAN_DEATH_EXPR	= "Я...проиграл.";
DBM_OSSIRIAN_EXPOSE		= "Expose";
DBM_OSSIRIAN_SPELLID_SUPREME	= 25176


-- Anubisath Guardians  (Ossirian)
DBM_GUARDIAN_NAME 			= "Анубисат-страж";
...
DBM_GUARDIAN_EXPLODE_EXPR	 	= "Анубисат-страж gains Explode.";
DBM_GUARDIAN_EXPLODE_ANNOUNCE		= "*** Explode ***";
DBM_GUARDIAN_ENRAGE_EXPR		= "Анубисат-страж gains Enrage.";
DBM_GUARDIAN_ENRAGE_ANNOUNCE		= "*** Enrage ***";
DBM_GUARDIAN_SPELLID_EXPLODE	= 25698
DBM_GUARDIAN_SPELLID_ENRAGE		= 26527
DBM_GUARDIAN_SPELLID_CLAP		= 26554
DBM_GUARDIAN_SPELLID_PLAGUE		= 26556
DBM_GUARDIAN_REALNAME		= "Анубисат-страж"
...
DBM_GUARDIAN_SUMMONGUARD_EXPR 		= "Анубисат .* casts Summon Anubisath Swarmguard.";
DBM_GUARDIAN_SUMMONEDGUARD_ANNOUNCE	= "*** Swarmguard Summoned ***";
DBM_GUARDIAN_SUMMONWARRIOR_EXPR 	= "Анубисат .* casts Summon Anubisath Warrior.";

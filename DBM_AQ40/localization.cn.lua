...
-- 6. Twin Emperors
	...
	DBM_TWINEMPS_CAST_SPELL_1		= "([^%s]+)施放了双子传送。";
...
--Viscidus
	DBM_VISCIDUS_NAME					= "维希度斯";
	DBM_VISCIDUS_DESCRIPTION			= "冰霜和近战攻击计数";
	DBM_VISCIDUS_SEND_WHISPER			= "密语玩家";
	DBM_VISCIDUS_SLASHHELP1				= "/维希度斯 MT名 - 设置一名MT已避免错误的毒云警报";
	DBM_VISCIDUS_MT_SET					= "MT设置为: ";
	DBM_VISCIDUS_MT_NOT_SET1 			= "没有设置MT！毒云警报将会错误的每15秒密语MT一次！";
	DBM_VISCIDUS_MT_NOT_SET2			= "输入“/维希度斯 MT名”来设置MT";
	
	DBM_VISCIDUS_TOXIN_ON				= "*** 毒云目标: ";
	DBM_VISCIDUS_TOXIN_ON_YOU			= "你在毒云中！";
	DBM_VISCIDUS_FREEZE_WARNING			= "*** 冰霜 %s/3 ***";
	DBM_VISCIDUS_FROZEN_WARNING			= "*** 冰霜 3/3 - 15秒后冻结 ***";
	DBM_VISCIDUS_SHATTER_WARNING		= "*** 碎裂 %s/3 ***";
	DBM_VISCIDUS_FROZEN_LEFT_WARNING	= "*** %s秒剩余 ***";
	DBM_VISCIDUS_FROST_HITS				= "冰霜攻击次数: ";
	DBM_VISCIDUS_FROST_HITS_WARNING		= "*** %s次冰霜攻击 ***";
	DBM_VISCIDUS_MELEE_HITS				= "近战攻击次数: ";
	DBM_VISCIDUS_MELEE_HITS_WARNING		= "*** %s次近战攻击 ***";
	
	DBM_VISCIDUS_SLOW_1					= "%s的速度慢下来了！";
	DBM_VISCIDUS_SLOW_2					= "%s冻结了！";
	DBM_VISCIDUS_SLOW_3					= "%s变成了坚硬的固体！";
	DBM_VISCIDUS_SHATTER_1				= "%s开始碎裂了！";
	DBM_VISCIDUS_SHATTER_2				= "%s马上就要碎裂的样子！";
	DBM_VISCIDUS_VISCIDUS				= "维希度斯";

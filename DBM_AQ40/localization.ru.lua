...
DBM_SKERAM_CAST_SPELL_AE		= "Arcane Explosion";
DBM_SKERAM_MIND_CONTROL_TEXTURE	= "Spell_Shadow_Charm";
DBM_SKERAM_MIND_CONTROL_DEBUFF	= "True Fulfillment";

-- 2. Three Bugs (Vem & Co)
DBM_THREEBUGS_NAME			= "Семейство насекомых";
DBM_THREEBUGS_YAUJ			= "Принцесса Яудж";
DBM_THREEBUGS_KRI			= "Лорд Кри";
DBM_THREEBUGS_VEM			= "Вем";
DBM_THREEBUGS_REAL_NAME		= "Three Bugs";
DBM_THREEBUGS_FEAR_EXPR		= "Fear";
...
DBM_SARTURA_NAME			= "Боевой страж Сартура"
...
DBM_SARTURA_GAIN_WHIRLWIND		= "Whirlwind";
...
-- 4. Fankriss
DBM_FANKRISS_NAME			= "Фанкрисс Непобедимый"
...
-- 5. Huhuran
DBM_HUHURAN_NAME			= "Принцесса Хухуран";
...
DBM_HUHURAN_WYVERN_REGEXP		= "Wyvern Sting";
DBM_HUHURAN_FRENZY			= "%s goes into a frenzy!";
DBM_HUHURAN_FRENZY_ANNOUNCE		= "*** Frenzy ***";
DBM_HUHURAN_HUHURAN			= "Принцесса Хухуран";



-- Anubisat Defenders
DBM_DEFENDER_NAME			= "Анубисат-защитники";
...
DBM_DEFENDER_GAIN_EXPLODE		= "Explode";
DBM_DEFENDER_PLAGUE_REGEXP		= "([^%s]+) (%w+) afflicted by Plague.";



-- 6. Twin Emperors
DBM_TWINEMPS_NAME			= "Императоры-близнецы";
...
DBM_TWINEMPS_VEKNILASH			= "Император Век'нилаш";
DBM_TWINEMPS_VEKLOR			= "Император Век'лор";
...
DBM_OURO_CAST_SWEEP			= "Оуро begins to cast Sweep.";
DBM_OURO_CAST_SAND_BLAST		= "Оуро begins to perform Sand Blast.";
...
DBM_CTHUN_CLAW				= "Claw";
DBM_CTHUN_EYE				= "Глаз";
DBM_CTHUN_DIES				= "Глаз Ка'Туна умирает.";
...
--Viscidus
DBM_VISCIDUS_NAME			= "Фиброзник";
DBM_VISCIDUS_DESCRIPTION		= "Counts frost and melee hits on Viscidus.";
DBM_VISCIDUS_SEND_WHISPER		= "Send whisper";
DBM_VISCIDUS_SLASHHELP1		= "/Фиброзник mt name - sets a main tank to prevent toxin warning spam";
...
DBM_VISCIDUS_VISCIDUS			= "Фиброзник";

...
DBM_THREEBUGS_FEAR_EXPR		= "(.+) (.+) subit les effets de Peur%.";
DBM_THREEBUGS_FEAR_ANNOUNCE		= "*** Yauj Fear dans %d sec ***";
DBM_THREEBUGS_CASTHEAL_EXPR		= "Princesse Yauj commence \195\160 lancer Soins exceptionnels.";
...
DBM_TWINEMPS_BUG_EXPLOE	=    "Annoncer quand un insecte va exploser";
...
-- 7. Ouro
DBM_OURO_NAME				= "Ouro";
DBM_OURO_DESCRIPTION			= "Activer timer quand ouro disparait ou apparait.";
...
DBM_OURO_DIRT_MOUND_QUAKE		= "%s lance Invocation de Monticules d'Ouro.";
DBM_OURO_ENRAGE			      = "%s entre dans une rage d\195\169mente !";
DBM_OURO_ENRAGE_ANNOUNCE		= "*** Enrager ***";
DBM_OURO_OURO				= "Ouro";
...
DBM_CTHUN_SEND_WHISPER			= "whisper";
DBM_CTHUN_SET_ICON			= "Mettre icone";
DBM_CTHUN_RANGE_CHECK			= "Range check";
DBM_CTHUN_RANGE_CHECK_PHASE2		= "Voir Range Frame pendant phase 2";
...
DBM_CTHUN_EYE				= "Oeil";
DBM_CTHUN_DIES				= "Œil de C'thun meurt.";
DBM_CTHUN_WEAKENED			= "%s est affaibli !";
